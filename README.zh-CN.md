...
当前版本为 v0.31.1。跨学科 fixture 只验证通用流程合同，不代表真实科研结果。真实论文仍必须使用 live-runnable 学科插件或可审计的 project-local 代码，产生经过验证的 run output，并由用户确认研究蓝图、核心证据、最终作者补全 packet 和发布 hash。Mock 与 fixture 不能冒充论文证据。
