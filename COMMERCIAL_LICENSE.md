...
Draftpaper-loop is available for non-commercial research, education,
evaluation, and personal paper-writing workflows under the repository license.

Commercial use requires prior written authorization from the project developer.
Commercial use includes, but is not limited to:

- paid paper-writing, research, consulting, or manuscript-production services;
- SaaS, hosted API, desktop, enterprise, or internal company deployments;
- resale, sublicensing, or bundling with paid courses, products, or services;
