...
- Sample ID: `10.1007_s00382-018-4286-0__block`
- Markdown to review: `tests/fixtures/block/10.1007_s00382-018-4286-0/extracted.md`
- Prompt path: `tests/fixtures/block/10.1007_s00382-018-4286-0/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/block/10.1007_s00382-018-4286-0/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1007/s00382-018-4286-0",
  "issues": [],
  "markdown_path": "tests/fixtures/block/10.1007_s00382-018-4286-0/extracted.md",
  "prompt_path": "tests/fixtures/block/10.1007_s00382-018-4286-0/markdown-quality-prompt.md",
  "provider": "springer",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1007_s00382-018-4286-0__block",
  "schema_version": 2,
  "status": "pass"
}
```
