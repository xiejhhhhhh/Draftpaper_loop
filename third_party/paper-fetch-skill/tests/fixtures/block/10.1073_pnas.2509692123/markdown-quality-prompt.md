...
- Sample ID: `10.1073_pnas.2509692123__block`
- Markdown to review: `tests/fixtures/block/10.1073_pnas.2509692123/extracted.md`
- Prompt path: `tests/fixtures/block/10.1073_pnas.2509692123/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/block/10.1073_pnas.2509692123/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1073/pnas.2509692123",
  "issues": [],
  "markdown_path": "tests/fixtures/block/10.1073_pnas.2509692123/extracted.md",
  "prompt_path": "tests/fixtures/block/10.1073_pnas.2509692123/markdown-quality-prompt.md",
  "provider": "pnas",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1073_pnas.2509692123__block",
  "schema_version": 2,
  "status": "pass"
}
```
