...
- Sample ID: `10.1063_5.0188905`
- Fixture purpose: `formula`
- Markdown to review: `tests/fixtures/golden_criteria/10.1063_5.0188905/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.1063_5.0188905/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.1063_5.0188905/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1063/5.0188905",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.1063_5.0188905/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.1063_5.0188905/markdown-quality-prompt.md",
  "provider": "aip",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1063_5.0188905",
  "schema_version": 2,
  "status": "pass"
}
```
