...
- Sample ID: `10.1111_gcb.15322`
- Markdown to review: `tests/fixtures/golden_criteria/10.1111_gcb.15322/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.1111_gcb.15322/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.1111_gcb.15322/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1111/gcb.15322",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.1111_gcb.15322/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.1111_gcb.15322/markdown-quality-prompt.md",
  "provider": "wiley",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1111_gcb.15322",
  "schema_version": 2,
  "status": "pass"
}
```
