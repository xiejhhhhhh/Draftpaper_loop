...
- Sample ID: `10.1098_rsta.2019.0558`
- Markdown to review: `tests/fixtures/golden_criteria/10.1098_rsta.2019.0558/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.1098_rsta.2019.0558/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.1098_rsta.2019.0558/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1098/rsta.2019.0558",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.1098_rsta.2019.0558/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.1098_rsta.2019.0558/markdown-quality-prompt.md",
  "provider": "royalsocietypublishing",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1098_rsta.2019.0558",
  "schema_version": 2,
  "status": "pass"
}
```
