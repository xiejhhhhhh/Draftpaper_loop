...
- Sample ID: `10.1093_bioinformatics_btaa153`
- Fixture purpose: `pdf_fallback`
- Markdown to review: `tests/fixtures/golden_criteria/10.1093_bioinformatics_btaa153/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.1093_bioinformatics_btaa153/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.1093_bioinformatics_btaa153/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1093/bioinformatics/btaa153",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.1093_bioinformatics_btaa153/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.1093_bioinformatics_btaa153/markdown-quality-prompt.md",
  "provider": "oxfordacademic",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1093_bioinformatics_btaa153",
  "schema_version": 2,
  "status": "pass"
}
```
