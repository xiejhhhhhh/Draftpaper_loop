...
- Sample ID: `10.3390_foods10081757`
- Markdown to review: `tests/fixtures/golden_criteria/10.3390_foods10081757/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.3390_foods10081757/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.3390_foods10081757/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.3390/foods10081757",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.3390_foods10081757/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.3390_foods10081757/markdown-quality-prompt.md",
  "provider": "mdpi",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.3390_foods10081757",
  "schema_version": 2,
  "status": "pass"
}
```
