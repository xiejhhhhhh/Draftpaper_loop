...
- Sample ID: `10.1175_jcli-d-23-0738.1`
- Markdown to review: `tests/fixtures/golden_criteria/10.1175_jcli-d-23-0738.1/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.1175_jcli-d-23-0738.1/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.1175_jcli-d-23-0738.1/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1175/jcli-d-23-0738.1",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.1175_jcli-d-23-0738.1/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.1175_jcli-d-23-0738.1/markdown-quality-prompt.md",
  "provider": "ams",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1175_jcli-d-23-0738.1",
  "schema_version": 2,
  "status": "pass"
}
```
