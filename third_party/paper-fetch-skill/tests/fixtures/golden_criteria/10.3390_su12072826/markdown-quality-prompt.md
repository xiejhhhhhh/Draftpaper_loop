...
- Sample ID: `10.3390_su12072826`
- Markdown to review: `tests/fixtures/golden_criteria/10.3390_su12072826/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.3390_su12072826/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.3390_su12072826/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.3390/su12072826",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.3390_su12072826/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.3390_su12072826/markdown-quality-prompt.md",
  "provider": "mdpi",
