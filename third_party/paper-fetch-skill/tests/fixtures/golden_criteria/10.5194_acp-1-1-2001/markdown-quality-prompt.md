...
- Sample ID: `10.5194_acp-1-1-2001`
- Markdown to review: `tests/fixtures/golden_criteria/10.5194_acp-1-1-2001/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.5194_acp-1-1-2001/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.5194_acp-1-1-2001/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.5194/acp-1-1-2001",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.5194_acp-1-1-2001/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.5194_acp-1-1-2001/markdown-quality-prompt.md",
  "provider": "copernicus",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.5194_acp-1-1-2001",
  "schema_version": 2,
  "status": "pass"
}
```
