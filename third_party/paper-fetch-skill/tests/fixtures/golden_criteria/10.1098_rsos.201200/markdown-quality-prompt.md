...
- Sample ID: `10.1098_rsos.201200`
- Markdown to review: `tests/fixtures/golden_criteria/10.1098_rsos.201200/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.1098_rsos.201200/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.1098_rsos.201200/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.1098/rsos.201200",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.1098_rsos.201200/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.1098_rsos.201200/markdown-quality-prompt.md",
  "provider": "royalsocietypublishing",
  "review_method": "agent_prompt",
  "reviewed_at": "<UTC ISO-8601 timestamp>",
  "reviewed_by": "<agent-or-operator-id>",
  "sample_id": "10.1098_rsos.201200",
  "schema_version": 2,
  "status": "pass"
}
```
