...
- Sample ID: `10.3390_membranes15030093`
- Markdown to review: `tests/fixtures/golden_criteria/10.3390_membranes15030093/extracted.md`
- Prompt path: `tests/fixtures/golden_criteria/10.3390_membranes15030093/markdown-quality-prompt.md`
- Report to write: `tests/fixtures/golden_criteria/10.3390_membranes15030093/markdown-quality.json`
...
```json
{
  ...
  "doi": "10.3390/membranes15030093",
  "issues": [],
  "markdown_path": "tests/fixtures/golden_criteria/10.3390_membranes15030093/extracted.md",
  "prompt_path": "tests/fixtures/golden_criteria/10.3390_membranes15030093/markdown-quality-prompt.md",
  "provider": "mdpi",
