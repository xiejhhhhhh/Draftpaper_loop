...
- Final local verification: `537 passed`; package/tests compile cleanly; the isolated v0.24.0 wheel matches 209 plugins, 545 fixtures, six capability packs and six third-party source lineages; all three domain regressions and every adversarial release check pass. Eval capture/replay is structural and privacy-preserving and never treats an existing manuscript as a quality baseline.
