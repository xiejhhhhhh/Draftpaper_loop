...
PLUGIN_MANIFEST = {'display_name': 'FlowIO FCS cytometry input', 'discipline': 'bioinformatics', 'packages': ['flowio'], 'package_modules': ['flowio'], 'maturity': 'foundation', 'runtime_class': 'local_optional_dependency', 'validation_level': 'fixture_runnable', 'aliases': ['flowio fcs cytometry'], 'provenance_notes': 'First-party foundation distilled from publicly documented local scientific Python capabilities; no upstream source code is copied.', 'connector_id': 'flowio_fcs_cytometry', 'access_modes': ['local_files'], 'download_or_access': ['Use parameterized local files or user-authorized exports.'], 'data_formats': ['csv', 'json', 'parquet'], 'requires_credentials': False, 'genericity_rules': ['Do not store credentials, server locations, or project-specific samples.']}
