...
PLUGIN_MANIFEST = {'display_name': 'Quantum-state tomography plan', 'discipline': 'quantum_science', 'packages': ['qiskit'], 'package_modules': ['qiskit'], 'maturity': 'foundation', 'runtime_class': 'local_optional_dependency', 'validation_level': 'fixture_runnable', 'aliases': ['quantum state tomography plan'], 'provenance_notes': 'First-party foundation distilled from publicly documented local scientific Python capabilities; no upstream source code is copied.', 'template_id': 'quantum_state_tomography_plan', 'method_family': 'quantum_state_tomography_plan', 'input_roles': ['analysis_table_or_array'], 'optional_roles': ['sample_group', 'metadata'], 'output_artifacts': ['methods/src/quantum_state_tomography_plan.py', 'results/tables/quantum_state_tomography_plan_summary.json'], 'figure_groups': ['method_diagnostic_or_result_summary'], 'formula_families': [], 'validation_checks': ['input_schema_check', 'dependency_check', 'held_out_or_sensitivity_check'], 'genericity_rules': ['Parameterize input columns, units, splits, and scientific hypotheses.']}
