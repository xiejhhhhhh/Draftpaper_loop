...
PLUGIN_MANIFEST = {'display_name': 'Matplotlib and Seaborn scientific visualization', 'discipline': 'default', 'packages': ['matplotlib', 'seaborn'], 'package_modules': ['matplotlib', 'seaborn'], 'maturity': 'foundation', 'runtime_class': 'local_optional_dependency', 'validation_level': 'fixture_runnable', 'aliases': ['matplotlib seaborn scientific visualization'], 'provenance_notes': 'First-party foundation distilled from publicly documented local scientific Python capabilities; no upstream source code is copied.', 'template_id': 'matplotlib_seaborn_scientific_visualization', 'method_family': 'matplotlib_seaborn_scientific_visualization', 'input_roles': ['analysis_table_or_array'], 'optional_roles': ['sample_group', 'metadata'], 'output_artifacts': ['methods/src/matplotlib_seaborn_scientific_visualization.py', 'results/tables/matplotlib_seaborn_scientific_visualization_summary.json'], 'figure_groups': ['method_diagnostic_or_result_summary'], 'formula_families': [], 'validation_checks': ['input_schema_check', 'dependency_check', 'held_out_or_sensitivity_check'], 'genericity_rules': ['Parameterize input columns, units, splits, and scientific hypotheses.']}
