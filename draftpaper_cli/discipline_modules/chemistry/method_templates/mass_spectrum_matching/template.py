...
PLUGIN_MANIFEST = {'display_name': 'Mass-spectrum matching', 'discipline': 'chemistry', 'packages': ['matchms'], 'package_modules': ['matchms'], 'maturity': 'foundation', 'runtime_class': 'local_optional_dependency', 'validation_level': 'fixture_runnable', 'aliases': ['mass spectrum matching'], 'provenance_notes': 'First-party foundation distilled from publicly documented local scientific Python capabilities; no upstream source code is copied.', 'template_id': 'mass_spectrum_matching', 'method_family': 'mass_spectrum_matching', 'input_roles': ['analysis_table_or_array'], 'optional_roles': ['sample_group', 'metadata'], 'output_artifacts': ['methods/src/mass_spectrum_matching.py', 'results/tables/mass_spectrum_matching_summary.json'], 'figure_groups': ['method_diagnostic_or_result_summary'], 'formula_families': [], 'validation_checks': ['input_schema_check', 'dependency_check', 'held_out_or_sensitivity_check'], 'genericity_rules': ['Parameterize input columns, units, splits, and scientific hypotheses.']}
