...
COMMAND_SPECS.update({
    ...
    "compare-checkpoint-decision": CommandSpec(
        ...
        "state",
        "checkpoint_summary",
        "compare_checkpoint_decision",
        (("project", "project"), ("checkpoint_hash", "checkpoint_hash"), ("against", "against")),
    ),
    "explain-reconfirmation": CommandSpec(
        "explain-reconfirmation",
        "state_kernel",
        False,
        "state",
        "checkpoint_summary",
        "explain_reconfirmation",
        (("project", "project"), ("checkpoint_package_id", "checkpoint_package_id")),
    ),
    "validate-checkpoint-readability": CommandSpec(
    ...
    "rebuild-checkpoint-presentation": CommandSpec(
        ...
        "state",
        "checkpoint_summary",
        "rebuild_checkpoint_presentation",
        (("project", "project"), ("checkpoint_package_id", "checkpoint_package_id")),
        allowed_write_globs=("review/checkpoints/**", *_COMMON_MANAGED_WRITES),
    ),
    ...
    "doctor": CommandSpec("doctor", "state_kernel", False, "state", "doctor", "doctor_project", (("project", "project"), ("explain", "explain"), ("target", "target"))),
    "verify-environment": CommandSpec(
        "verify-environment",
        "state_kernel",
        False,
        "environment",
        ...
        "verify_environment",
        (("target", "target"), ("compile_latex", "compile_latex"), ("output", "output")),
        exit_policy="status_passed",
        risk_level="execute_science",
        mcp_exposed=False,
    ),
    ...
    "prepare-manuscript-completion": CommandSpec(
        ...
        (("project", "project"),),
        allowed_write_globs=("writing/manuscript_completion/template.yaml", "writing/manuscript_completion/missing_fields.json"),
    ),
    "manuscript-completion-status": CommandSpec(
    ...
    "preview-manuscript-completion": CommandSpec(
        ...
        (("project", "project"), ("input_path", "input")),
        allowed_write_globs=(
            "writing/manuscript_completion/packets/**",
            "latex/manuscript_source_map.json",
            "writing/revision_workspace.json",
            "writing/review_revision_queue.json",
        ),
    ),
    "apply-manuscript-completion": CommandSpec(
        ...
        (("project", "project"), ("packet_id", "packet_id"), ("packet_hash", "packet_hash")),
        protected_action=True,
    ),
    "rollback-manuscript-completion": CommandSpec(
        ...
        (("project", "project"), ("transaction_id", "transaction_id")),
        protected_action=True,
    ),
