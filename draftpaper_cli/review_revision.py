...
def _commands_from_stage(target_stage: str) -> list[str]:
    mapping = {
        "references": ["search-literature", "generate-plan", "prepare-data-acquisition", "inventory-data", "assess-data-quality", "assess-data-feasibility", "collect-method-plan", "plan-figures", "generate-analysis-code", "verify-methods", "assess-result-validity", "assess-core-evidence", "inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "research_plan": ["generate-plan", "prepare-data-acquisition", "inventory-data", "assess-data-quality", "assess-data-feasibility", "collect-method-plan", "plan-figures", "generate-analysis-code", "verify-methods", "assess-result-validity", "assess-core-evidence", "inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "data": ["prepare-data-acquisition", "inventory-data", "assess-data-quality", "assess-data-feasibility", "collect-method-plan", "plan-figures", "generate-analysis-code", "verify-methods", "assess-result-validity", "assess-core-evidence", "inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "method_plan": ["collect-method-plan", "plan-figures", "generate-analysis-code", "verify-methods", "assess-result-validity", "assess-core-evidence", "inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "figure_plan": ["plan-figures", "generate-analysis-code", "verify-methods", "assess-result-validity", "assess-core-evidence", "inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "code": ["plan-figures", "generate-analysis-code", "verify-methods", "assess-result-validity", "assess-core-evidence", "inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "methods": ["plan-figures", "generate-analysis-code", "verify-methods", "assess-result-validity", "assess-core-evidence", "inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "result_validity": ["assess-result-validity", "assess-core-evidence", "inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "core_evidence": ["assess-core-evidence", "inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "results": ["inventory-results", "write-results", "write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "introduction": ["write-introduction", "build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "data_writing": ["build-data-context", "write-data", "build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
        "methods_writing": ["build-method-context", "write-methods", "write-discussion", "assemble-latex", "run-integrity-gate", "quality-check"],
